...
LDFLAGS = -lrt -pthread -lm -lz # Link with real-time, pthread, math, and zlib
...
# Filter out main.c from helpers to avoid duplicate main objects
SERVER_HELPERS = $(filter-out $(SERVER_MAIN), $(SERVER_HELPER_SRCS))

# --- Object Generation ---
# Converts src/xxx/file.c -> obj/xxx/file.o
